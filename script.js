// ===================================================
// ملف script.js - منطق التطبيق الكامل (نسخة محسّنة ومتوافقة مع GitHub Pages)
// جميع التعليقات بالعربية لشرح كل وظيفة وتفاصيل التحسين
// ===================================================

/******************************************
 * 0. انتظار تحميل DOM بالكامل قبل البدء  *
 ******************************************/
document.addEventListener('DOMContentLoaded', function() {
    ...
    (function initOptimizedBackground() {
        ...
        // إذا لم يوجد canvas نخرج فوراً (لمنع الأخطاء)
        if (!canvas) return;
        ...
        function generateMockUsers() {
            ...
            for (let i = 1; i <= 100; i++) {
                ...
                users.push({
                    ...
                    username: username,
                    password: '123456', // كلمة مرور افتراضية للوهميين
     ...
     *    MapsTo(pageId) - مع تأثيرات الظهور  *
     ******************************************/
    ...
    (function initVisitorCounter() {
        const counterElement = document.getElementById('total-visitors-count');
        if (!counterElement) return;

        const COUNTER_NAMESPACE = 'tasbeeh-smart-app';
        ...
        fetch(`https://api.countapi.xyz/hit/${COUNTER_NAMESPACE}/${COUNTER_KEY}`)
            ...
            .catch(() => {
                // في حالة الفشل (مشكلة CORS أو عدم اتصال)، نعرض رقمًا افتراضيًا
    ...
    const TasbeehApp = (function() {
        ...
        const top100Page = document.getElementById('top100Page');
        ...
        let authMode = 'register'; // 'register' أو 'login'
        ...
        function bindEvents() {
            ...
            // أزرار القائمة السفلية (Bottom Navigation)
            const bottomNavHome = document.getElementById('bottomNavHome');
            const bottomNavTasbeeh = document.getElementById('bottomNavTasbeeh');
            const bottomNavFatimah = document.getElementById('bottomNavFatimah');
            const bottomNavTop100 = document.getElementById('bottomNavTop100');
            ...
            if (bottomNavTasbeeh) {
                bottomNavTasbeeh.addEventListener('click', () => {
                    Router.goTo('main');
                    // تفعيل تبويب الذكي
                    tabTasbeeh.click();
                });
            ...
            if (bottomNavFatimah) {
                bottomNavFatimah.addEventListener('click', () => {
                    Router.goTo('main');
                    tabFatimah.click();
                });
            }
            if (bottomNavTop100) {
                bottomNavTop100.addEventListener('click', () => {
                    openTop100();
                });
            }
        }
        ...
        function start() {
            ...
            if (currentUser) {
                ...
                if (progressContainer && progressBar) {
                    ...
                    // في حال عدم وجود العناصر نذهب مباشرة
                    initUser();
                    Router.goTo('main');
                }
            } else {
